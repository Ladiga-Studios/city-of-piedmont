...
const ITEMS = [
  ...
  { href: '/admin/careers', label: 'Careers', icon: 'M3 8h18v12H3zM8 8V5a2 2 0 012-2h4a2 2 0 012 2v3M3 13h18' },
  ...
  { href: '/admin/drive', label: 'File Drive', icon: 'M3 7a2 2 0 012-2h4l2 2h8a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V7zM12 11v5m0 0l-2-2m2 2l2-2' },
];
